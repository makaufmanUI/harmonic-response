...
st.sidebar.write(" ")
sim_folder = st.sidebar.selectbox("Dataset", options=["sim6", "sim7", "sim8", "sim9", "sim10", "sim11", "sim12", "sim13", "sim14", "sim15", "sim16", "sim17", "sim18"], index=6, key="sim_folder", help="Select the dataset to use for plotting")
st.sidebar.markdown("---")
